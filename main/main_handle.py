...
def main():
    ...
    mqtt_client = FirebaseClient()  # Initialize MQTT client with token and connection handler
    ...
    try:
        ...
        gps_thread = threading.Thread(target=sensor_handler.read_gps_data)  # Use instance method for GPS
